...
(() => {
/*!*****************************************!*\
  !*** ./blocks/image-carousel/splide.js ***!
  \*****************************************/
__webpack_require__.r(__webpack_exports__);
...
document.addEventListener("DOMContentLoaded", () => {
  const imgCarousels = document.querySelectorAll(".blockons-image-carousel-slider");

  if (imgCarousels) {
    imgCarousels.forEach(slider => {
      const theCarousel = document.getElementById(slider.id);
      const theCarouselSettings = JSON.parse(theCarousel.getAttribute("data-settings"));
      ...
      if (sliderElement) {
        if (parseInt(slidesNumber) === 1) {
          var aSlider = new _splidejs_splide__WEBPACK_IMPORTED_MODULE_0__["default"](sliderElement, theCarouselSettings);
          ...
          aSlider.mount(); // updateHeight(aSlider);
        } else {
          // console.log("multiple slides");
          new _splidejs_splide__WEBPACK_IMPORTED_MODULE_0__["default"](sliderElement, theCarouselSettings).mount();
        }
      }
    });
  }
