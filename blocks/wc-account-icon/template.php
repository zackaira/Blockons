...
<div <?php echo wp_kses_data( get_block_wrapper_attributes(['class' => $custom_classes]) ); ?>>
	<div class="blockons-wc-account-icon-block">
		<div class="blockons-wc-account-icon" style="<?php echo isset($attributes['iconBgColor']) ? 'background-color: ' . esc_attr($attributes['iconBgColor']) . ';' : ''; ?> <?php echo isset($attributes['iconSize']) ? 'font-size: ' . esc_attr($attributes['iconSize']) . 'px;' : ''; ?> <?php echo isset($attributes['iconPadding']) ? 'padding: ' . esc_attr($attributes['iconPadding']) . 'px;' : ''; ?>">
