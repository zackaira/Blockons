 ...
 */
function blockons_wc_account_icon_load_textdomain() {
	load_plugin_textdomain( 'blockons', false, basename( __DIR__ ) . '/languages' );
}
add_action( 'init', 'blockons_wc_account_icon_load_textdomain' );
...
function blockons_wc_account_icon_register_block() {
	...
	if ( function_exists( 'wp_set_script_translations' ) ) {
		 ...
		 */
		wp_set_script_translations( 'blockons-wc-account-icon', 'blockons' );
	}
