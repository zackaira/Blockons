...
function blockons_video_slider_register_block() {
	...
	register_block_type(
		__DIR__,
		array(
			'render_callback' => 'blockons_video_slider_render_callback',
		)
	);

	if ( function_exists( 'wp_set_script_translations' ) ) {
		wp_set_script_translations( 'blockons-video-slider-editor-script', 'blockons', BLOCKONS_PLUGIN_DIR . 'lang' );
	}
 ...
 */
function blockons_video_slider_render_callback( $attributes, $content, $block_instance ) {
	ob_start();
	/**
