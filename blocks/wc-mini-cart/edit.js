				...
				<InspectorControls>
					...
					>
						...
						<ToggleControl
							...
							checked={noAmount}
							onChange={(newValue) =>
								setAttributes({ noAmount: newValue })
							}
							__nextHasNoMarginBottom={true}
						/>
						<ToggleControl
							...
							checked={noItems}
							onChange={(newValue) =>
								setAttributes({ noItems: newValue })
							}
							__nextHasNoMarginBottom={true}
						/>
						<div className="blockons-divider"></div>
					...
					>
						<SelectControl
							...
							options={[
								...
								{
									label: __('Drop Down Cart', 'blockons'),
									value: 'dropdown',
								},
								{
									label: __(
						...
						{cartType === 'dropdown' && (
							<>
								...
								<SelectControl
									...
									options={[
										{
											label: __('Dark', 'blockons'),
											value: 'dark',
										},
										{
											label: __('Light', 'blockons'),
											value: 'light',
										},
									]}
									onChange={(newValue) =>
