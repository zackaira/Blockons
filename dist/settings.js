...
HTMLReactParser.Element = (__webpack_require__(7915).Element);
...
;// CONCATENATED MODULE: ./src/backend/components/inputs/InputToggleSwitch.js
...
;// CONCATENATED MODULE: ./src/backend/components/UI/Heading.js


var Heading = function Heading(_ref) {
  var title = _ref.title,
      description = _ref.description,
      marginzero = _ref.marginzero;
  return /*#__PURE__*/react.createElement(react.Fragment, null, /*#__PURE__*/react.createElement("div", {
    className: "blockonsheading ".concat(marginzero ? "nomargin" : "")
...
;// CONCATENATED MODULE: ./src/backend/components/SettingRow.js
...
/* harmony default export */ const components_SettingRow = (SettingRow);
;// CONCATENATED MODULE: ./src/backend/components/SettingBlock.js




var SettingBlock_SettingRow = function SettingRow(props) {
  return /*#__PURE__*/react.createElement(react.Fragment, null, /*#__PURE__*/react.createElement("div", {
    className: "blockons-block"
  }, /*#__PURE__*/react.createElement("div", {
    className: "blockons-block-inner"
  }, props.pluginSpecific && /*#__PURE__*/react.createElement("div", {
    className: "wcbanner"
  }, props.pluginSpecific), /*#__PURE__*/react.createElement("h4", {
...
/* harmony default export */ const SettingBlock = (SettingBlock_SettingRow);
...
/* harmony default export */ const node_modules_html_react_parser = ((/* unused pure expression or super */ null && (HTMLReactParser)));

;// CONCATENATED MODULE: ./src/backend/InfoTab.js
...
var InfoTab = function InfoTab(props) {
  ...
  }, /*#__PURE__*/react.createElement("h2", null, "Blockons"), /*#__PURE__*/react.createElement("p", null, "blah blah blah"), /*#__PURE__*/react.createElement("div", {
    className: "blockonsVideo"
  }, /*#__PURE__*/react.createElement("a", {
    href: "https://www.youtube.com/watch?v=4fCIDCcDgaU",
    target: "_blank",
    className: "blockonsVideoIn"
  })), /*#__PURE__*/react.createElement("h4", null, "some more blah blah"), /*#__PURE__*/react.createElement("p", null, "ha ha blah blah"), /*#__PURE__*/react.createElement("div", {
    className: "blockonsDashBtns"
  }, /*#__PURE__*/react.createElement("a", {
    href: "http://wpsitechat.com/documentation/",
    target: "_blank",
    className: "button blockonsDashBtn"
  }, "Documentation"), /*#__PURE__*/react.createElement("a", {
...
/* harmony default export */ const backend_InfoTab = (InfoTab);
;// CONCATENATED MODULE: ./src/backend/Loader.js
...
;// CONCATENATED MODULE: ./src/backend/Settings.js
...
var Settings = function Settings() {
  var _blockonsOptions$bloc, _blockonsOptions$bloc2, _blockonsOptions$bloc3, _blockonsOptions$bloc4, _blockonsOptions$bloc5, _blockonsOptions$bloc6, _blockonsOptions$bloc7, _blockonsOptions$bloc8, _blockonsOptions$bloc9, _blockonsOptions$bloc10, _blockonsOptions$bloc11, _blockonsOptions$bloc12;
  ...
  var _useState3 = (0,react.useState)(true),
      ...
      setLoadSetting = _useState4[1]; // const isPremium = blockonsObject.can_use_premium_code === "1" ? true : false;


  var _useState5 = (0,react.useState)({}),
      _useState6 = _slicedToArray(_useState5, 2),
      blockonsOptions = _useState6[0],
      setWascOptions = _useState6[1]; // const wcActive = Boolean(blockonsObject.wcActive);
  ...
  var handleChange = function handleChange(_ref) {
    ...
    setWascOptions(_objectSpread(_objectSpread({}, blockonsOptions), !settingGroup || settingGroup === "global" // sn_ name gets saved as default / in no group
    ? _defineProperty({}, groupKey, value) : _defineProperty({}, settingGroup, _objectSpread(_objectSpread({}, blockonsOptions[settingGroup]), {}, _defineProperty({}, settingName, value)))));
  };

  (0,react.useEffect)(function () {// blockonsAdjustUI();
  }, [blockonsOptions.add_blockons]);
  console.log(blockonsOptions); // Submit form

  var handleSubmit = function handleSubmit(e) {
    e.preventDefault();
    setLoader(true);
    axios_default().post(url + "/settings", {
  ...
  var handleDeleteOptions = function handleDeleteOptions(e) {
    ...
    if (window.confirm(default_i18n_("Are you sure you want to delete all settings?", "blockons"))) {
      setLoader(true);
      setLoadSetting(true);
      axios_default()["delete"](url + "/delete", {
        headers: {
          "X-WP-NONCE": blockonsObject.nonce
        }
      }).then(function (res) {
  ...
  (0,react.useEffect)(function () {
    axios_default().get(url + "/settings").then(function (res) {
      var blockonsOptions = res.data.blockonsOptions ? JSON.parse(res.data.blockonsOptions) : console.log("Blockons Options Empty"); // setState dynamically for all settings

      if (blockonsOptions) {
        var _loop = function _loop(key) {
          setWascOptions(function (prevState) {
            return _objectSpread(_objectSpread({}, prevState), {}, _defineProperty({}, key, blockonsOptions[key] ? blockonsOptions[key] : ""));
          });
        };
      ...
      setLoadSetting(false); // blockonsAdjustUI(blockonsOptions.add_blockons);
    });
  }, []);
  return /*#__PURE__*/react.createElement(react.Fragment, null, /*#__PURE__*/react.createElement("div", {
  ...
  }, /*#__PURE__*/react.createElement("h2", null, "Blockons Settings"), /*#__PURE__*/react.createElement("div", {
    ...
    id: "blockonstab-1",
    className: "blockons-tab active"
  }, default_i18n_("Blocks", "blockons"))), /*#__PURE__*/react.createElement("li", null, /*#__PURE__*/react.createElement("a", {
    id: "blockonstab-2",
    className: "blockons-tab"
  }, default_i18n_("Settings", "blockons"))), /*#__PURE__*/react.createElement("li", null, /*#__PURE__*/react.createElement("a", {
    id: "blockonstab-3",
    className: "blockons-tab"
  }, default_i18n_("Extra", "blockons"))), /*#__PURE__*/react.createElement("li", {
    className: "help"
  }, /*#__PURE__*/react.createElement("a", {
    id: "blockonstab-help",
    className: "blockons-tab"
  }, default_i18n_("Help", "blockons")))), /*#__PURE__*/react.createElement("div", {
  ...
  }, /*#__PURE__*/react.createElement(SettingBlock, {
    title: "Accordions",
    slug: "blocks_accordions",
    value: (_blockonsOptions$bloc = blockonsOptions.blocks) === null || _blockonsOptions$bloc === void 0 ? void 0 : _blockonsOptions$bloc.accordions,
    inputType: "toggle",
    ...
    value: (_blockonsOptions$bloc2 = blockonsOptions.blocks) === null || _blockonsOptions$bloc2 === void 0 ? void 0 : _blockonsOptions$bloc2.icon_list,
    inputType: "toggle",
    ...
    value: (_blockonsOptions$bloc3 = blockonsOptions.blocks) === null || _blockonsOptions$bloc3 === void 0 ? void 0 : _blockonsOptions$bloc3.image_carousel,
    inputType: "toggle",
    ...
    value: (_blockonsOptions$bloc4 = blockonsOptions.blocks) === null || _blockonsOptions$bloc4 === void 0 ? void 0 : _blockonsOptions$bloc4.line_heading,
    inputType: "toggle",
    description: "Block Three Description",
    onChange: handleChange
  }), /*#__PURE__*/react.createElement(SettingBlock, {
    ...
    value: (_blockonsOptions$bloc5 = blockonsOptions.blocks) === null || _blockonsOptions$bloc5 === void 0 ? void 0 : _blockonsOptions$bloc5.marketing_button,
    inputType: "toggle",
    description: "Block Three Description",
    onChange: handleChange
  }), /*#__PURE__*/react.createElement(SettingBlock, {
    ...
    value: (_blockonsOptions$bloc6 = blockonsOptions.blocks) === null || _blockonsOptions$bloc6 === void 0 ? void 0 : _blockonsOptions$bloc6.progress_bars,
    inputType: "toggle",
    description: "Block Three Description",
    onChange: handleChange
  }), /*#__PURE__*/react.createElement(SettingBlock, {
    title: "Search",
    slug: "blocks_search",
    value: (_blockonsOptions$bloc7 = blockonsOptions.blocks) === null || _blockonsOptions$bloc7 === void 0 ? void 0 : _blockonsOptions$bloc7.search,
    inputType: "toggle",
    description: "Block Three Description",
    onChange: handleChange
  }), /*#__PURE__*/react.createElement(SettingBlock, {
    ...
    value: (_blockonsOptions$bloc8 = blockonsOptions.blocks) === null || _blockonsOptions$bloc8 === void 0 ? void 0 : _blockonsOptions$bloc8.testimonials,
    inputType: "toggle",
    description: "Block Three Description",
    onChange: handleChange
  }), /*#__PURE__*/react.createElement(SettingBlock, {
    ...
    value: (_blockonsOptions$bloc9 = blockonsOptions.blocks) === null || _blockonsOptions$bloc9 === void 0 ? void 0 : _blockonsOptions$bloc9.video_slider,
    inputType: "toggle",
    description: "Block Three Description",
    onChange: handleChange
  }), /*#__PURE__*/react.createElement(SettingBlock, {
    ...
    value: (_blockonsOptions$bloc10 = blockonsOptions.blocks) === null || _blockonsOptions$bloc10 === void 0 ? void 0 : _blockonsOptions$bloc10.wc_account_icon,
    inputType: "toggle",
    description: "Block Three Description",
    onChange: handleChange,
    ...
    value: (_blockonsOptions$bloc11 = blockonsOptions.blocks) === null || _blockonsOptions$bloc11 === void 0 ? void 0 : _blockonsOptions$bloc11.wc_featured_product,
    inputType: "toggle",
    description: "Block Three Description",
    onChange: handleChange,
    pluginSpecific: "WooCommerce"
    ...
    value: (_blockonsOptions$bloc12 = blockonsOptions.blocks) === null || _blockonsOptions$bloc12 === void 0 ? void 0 : _blockonsOptions$bloc12.wc_mini_cart,
    inputType: "toggle",
    description: "Block Three Description",
    onChange: handleChange,
    pluginSpecific: "WooCommerce"
    ...
    description: default_i18n_("this is a description for the heading component", "blockons"),
    inputType: "heading"
    ...
    className: "form-table",
    role: "presentation"
  }, /*#__PURE__*/react.createElement("tbody", null, /*#__PURE__*/react.createElement("tr", null, /*#__PURE__*/react.createElement("td", null, "content 3"))))), /*#__PURE__*/react.createElement("div", {
    id: "blockons-content-help",
    className: "blockons-content"
  }, /*#__PURE__*/react.createElement(backend_InfoTab // isPro={isPremium}
  ...
  }, default_i18n_("Save Settings", "blockons")), /*#__PURE__*/react.createElement("div", {
    className: "blockonsSaveBtnLoader"
  }, (loadSetting || loader) && /*#__PURE__*/react.createElement(backend_Loader, null))), /*#__PURE__*/react.createElement("div", {
    className: "blockonsSettingBarOptions"
  }, /*#__PURE__*/react.createElement("div", {
    className: "blockons-delete",
    title: default_i18n_("Delete Settings", "blockons"),
    onClick: confirmDelete
  }, /*#__PURE__*/react.createElement("div", {
    className: "blockons-confirm-delete"
  }, /*#__PURE__*/react.createElement("a", {
    onClick: handleDeleteOptions
  }, default_i18n_("Confirm... Delete Settings!", "blockons"))))))))))));
};

/* harmony default export */ const backend_Settings = (Settings);
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (_typeof(element) !== undefined && element !== null) {
    react_dom.render( /*#__PURE__*/react.createElement(backend_Settings, null), document.getElementById("blockons-root"));
  }
  /*
  ...
  var tabItems = document.querySelectorAll(".blockons-tab");
  var contentItems = document.querySelectorAll(".blockons-content");
  tabItems.forEach(function (item) {
    item.addEventListener("click", function () {
      ...
      item.classList.add("active"); // Add / Remove Content hide class

      var contentName = "blockons-content-" + item.id.substring(item.id.indexOf("-") + 1);
      var contentShow = document.getElementById(contentName);
      contentItems.forEach(function (contItem) {
