...
Take your buttons beyond the basics. The Advanced Button block lets you create stylish buttons and customize them exactly as you want, with custom hover states too and built-in hover animations to better grab your visitors attention.

Upgrade to PRO and unlock extra powerful button features like Click-to-View extra content, creating custom Modal Popups, and also get WooCommerce Product Quick View... Giving you even more ways to engage your visitors and drive conversions.
...
= 1.2.15 =
* Styling tweaks/fixes
* Fixed Slider index key missing
* Update Freemius SDK
