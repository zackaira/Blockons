							...
							{isPremium ? (
								<>
									...
									<SettingRow
										...
										value={
											blockonsOptions.tooltips?.pfcolor
										}
										inputType="colorpicker"
										defaultValue="#FFF"
										onChange={onSettingChange}
									...
									{imgPopupsPro && (
										<SettingRow
											...
											proFeatures={[
												...
												__(
													'Edit icon design, colors & position',
													'blockons',
												),
												__(
					...
					{isPremium ? (
							...
							{blockonsOptions.blockvisibility?.enabled && (
								<>
									<SettingRow
										...
										value={
											blockonsOptions.blockvisibility
												?.tablet
										}
										placeholder="980"
										inputType="number"
						...
						<>
							<SettingRow
								...
								value={visibilityPro}
								onChange={() =>
									setVisibilityPro(!visibilityPro)
								}
								documentation="https://blockons.com/documentation/block-visibility-per-device/"
							/>
							{visibilityPro && (
					...
					{isPremium ? (
						...
						<>
							<SettingRow
								...
								value={animationsPro}
								onChange={() =>
									setAnimationsPro(!animationsPro)
								}
								tooltip={__(
									'Add neat scroll in and/or out animations to core layout blocks. This boosts the visual appeal of your website and makes it more engaging for users.',
									'blockons',
							...
							{animationsPro && (
								<SettingRow
									...
									proFeatures={[
										__(
											'Add Scroll Animations to Layout Blocks',
											'blockons',
										),
										__(
											'Edit block animation style',
											'blockons',
										),
										__(
