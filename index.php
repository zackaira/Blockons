...
/**
 * Load all translations for the plugin from the MO files.
 */
function blockons_load_textdomain() {
	load_plugin_textdomain( 'blockons', false, basename( __DIR__ ) . '/lang' );
}
add_action( 'init', 'blockons_load_textdomain' );
