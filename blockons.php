 ...
 * Domain Path: /lang/
 * 
 * @fs_premium_only /dist/pro/, /assets/blocks/search/pro/, /assets/blocks/contact-form/, /assets/blocks/wc-mini-cart/pro/, /assets/aos/, /assets/slider/swiper-video.js, /assets/popups/quickview/, 
 *
 * @package blockons
 */
...
if ( !defined( 'BLOCKONS_PLUGIN_VERSION' ) ) {
	define('BLOCKONS_PLUGIN_VERSION', '1.2.02');
}
